...
• <code>/nsfw off</code> - धुंधलापन सक्षम करें
    ...
    # Error messages
    ERROR_CHECK_SUPPORTED_SITES_MSG = "संभावना है कि यह साइट समर्थित नहीं है।"
    ...
    ERROR_COOKIE_INSTRUCTIONS_MSG = "YouTube के लिए - <b>/cookie</b> कमांड के माध्यम से <code>cookie</code> प्राप्त करें। किसी अन्य समर्थित साइट के लिए - अपना स्वयं का cookie भेजें और उसके बाद अपना वीडियो लिंक फिर से भेजें।"
